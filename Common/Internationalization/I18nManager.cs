...
using HyacineCore.Server.Internationalization.Message;
...
public static class I18NManager
{
    ...
    {
        var languageStr = "HyacineCore.Server.Internationalization.Message.Language" +
        ...
        if (languageType == null)
        {
            ...
            // fallback to English
            languageType = Type.GetType("HyacineCore.Server.Internationalization.Message.LanguageEN")!;
        }
    ...
    public static string TranslateAsCertainLang(string langStr, string key, params string[] args)
    {
        var languageStr = "HyacineCore.Server.Internationalization.Message.Language" +
                          langStr;
        var languageType = Type.GetType(languageStr) ??
                           Type.GetType("HyacineCore.Server.Internationalization.Message.LanguageEN")!;
        var language = Activator.CreateInstance(languageType) ?? throw new Exception("Language not found");
